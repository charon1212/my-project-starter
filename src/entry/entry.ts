...
import { mode_91_create_env } from "../mode/91_create_env/mode_91_create_env";
...
export const entry = async () => {
  const selectedMenu = await menu<() => unknown>([
    ...
    { id: 91, title: 'create-env', desc: 'create this application env file', value: mode_91_create_env, },
